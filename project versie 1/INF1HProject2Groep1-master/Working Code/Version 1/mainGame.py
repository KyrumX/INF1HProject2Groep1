...
def program(maxp):
    ...
    if maxp <= 2:
        playerOne = Player(550, 780, img1)
        playerTwo = Player(480, 780, img2)
    elif maxp == 3:
        playerOne = Player(550, 585, img1)
        playerTwo = Player(550, 585, img2)
        playerThree = Player(550, 585, img3)
    else:
        playerOne = Player(550, 585, img1)
        playerTwo = Player(550, 585, img2)
        playerThree = Player(550, 585, img3)
        playerFour = Player(550, 585, img4)
    ant = "1999"
    cp = 1
